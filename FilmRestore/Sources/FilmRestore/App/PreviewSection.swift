            ...
            GroupBox {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack(spacing: 16) {
                        ...
                        Toggle("Circle detections", isOn: $model.dirt.mcCircleMask)
                            .help("Draw obvious rings around every detection (red = dirt, yellow = AI) — easier to spot than the tint overlay")
